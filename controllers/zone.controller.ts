...
// ─────────────────────────────────────────────────────────────────────────────
// ADMIN: GET /api/v1/zones (List all Delivery Zones)
// ─────────────────────────────────────────────────────────────────────────────
export const getAllZones = async (req: Request, res: Response) => {
  ...
  const zones = await DeliveryZone.find(query).sort({ createdAt: -1 }).lean();
...
// ─────────────────────────────────────────────────────────────────────────────
// PUBLIC / APP: GET /api/v1/zones/active (List active zones)
// ─────────────────────────────────────────────────────────────────────────────
export const getActiveZones = async (req: Request, res: Response) => {
  const active = await DeliveryZone.find({ isActive: true }).lean();

  const activeList = active.map((z) => ({
    _id: z._id,
    name: z.name || z.state || z.city || "Delivery Zone",
    center: z.center || { lat: 28.4595, lng: 77.0266 },
    radiusKm: z.radiusKm || 15,
...
// ─────────────────────────────────────────────────────────────────────────────
// ADMIN: POST /api/v1/zones (Create a new Delivery Zone)
// ─────────────────────────────────────────────────────────────────────────────
export const createCityZone = async (req: Request, res: Response) => {
  const { name, state, city, lat, lng, radiusKm, isActive } = req.body;
...
// ─────────────────────────────────────────────────────────────────────────────
// PUBLIC / APP: GET /api/v1/zones/check?lat=...&lng=... (Geofence validation)
// ─────────────────────────────────────────────────────────────────────────────
